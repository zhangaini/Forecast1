...
public class NavBarBack extends Toolbar {
    ...
    public NavBarBack(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    @Click(R.id.ivMenuRightIv)
    void onRightMenuImageClick(View view) {
        if (mOnMenuClickListener != null) {
            mOnMenuClickListener.onRightMenuClick(view);
        }
    }
    ...
    public void setRightMenuIcon(@DrawableRes int drawableRes) {
        ...
        ivMenuRightIv.setImageResource(drawableRes);
    }

    public void setRightTxt(String str) {
        ivMenuRightTxt.setText(str);
        ivMenuRightTxt.setVisibility(View.VISIBLE);
    }

    public void setRightTxtIsVisible(boolean isVisible) {
        ivMenuRightTxt.setVisibility(isVisible ? VISIBLE : GONE);
    }
