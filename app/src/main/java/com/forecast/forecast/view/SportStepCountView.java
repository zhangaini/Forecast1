...
import com.forecast.forecast.imagePacker.Utils;
...
public class SportStepCountView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //中间的步数写在这里
        mValueOffset = cy + getBaselineOffsetFromY(mValuePaint)+ Utils.dp2px(mContext,5);
        //这个是写步数
        canvas.drawText(String.valueOf(mFootStep), cx, mValueOffset, mValuePaint);

        mHintOffset = cy - radius * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mUnitPaint)+ Utils.dp2px(mContext,20);
