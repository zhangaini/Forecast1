...
public class WaterWaveAttrInit {
	...
	public WaterWaveAttrInit(Context context, AttributeSet attrs, int defStyle, int count) {
		if (count > 100) {
			...
			progressColor = typedArray.getColor(
					R.styleable.WaterWaveProgress_progressColor, Color.RED);
			progressBgColor = typedArray.getColor(
					R.styleable.WaterWaveProgress_progressBgColor, Color.RED);
			waterWaveColor = typedArray.getColor(
					R.styleable.WaterWaveProgress_waterWaveColor, Color.RED);
			waterWaveBgColor = typedArray.getColor(
					R.styleable.WaterWaveProgress_waterWaveBgColor, Color.RED);
