package com.forecast.forecast.view.progress;
...
public class DialProgress extends View {
    ...
    private void initPaint() {
        ...
        mArcPaint.setStrokeWidth(mDialWidth);
        mArcPaint.setColor(mDialColor);
        mArcPaint.setStrokeCap(Paint.Cap.BUTT);

        mBgArcPaint = new Paint();
        mBgArcPaint.setAntiAlias(true);
        mBgArcPaint.setStyle(Paint.Style.STROKE);
        mBgArcPaint.setStrokeWidth(mDialWidth);
        ...
        Log.e("mDialWidth", "mDialWidth   " + mDialWidth);
        Log.e("mArcWidth", "mArcWidth   " + mArcWidth);
    }
...
//        mArcPaint.setShader(sweepGradient);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mUnitOffset = mCenterPoint.y + mRadius - mRadius * 0.2f + getBaselineOffsetFromY(mUnitPaint);
...
//        drawArc(canvas);
    ...
    private void drawDial(Canvas canvas) {
        ...
        int value_show = (int) (mSweepAngle * mPercent / mDialIntervalDegree);
        canvas.save();
        canvas.rotate(mStartAngle, mCenterPoint.x, mCenterPoint.y);
        for (int i = 0; i <= total; i++) {
            if (i <= value_show && value_show != 0) {
                canvas.drawLine(mCenterPoint.x + mRadius - 1, mCenterPoint.y, mCenterPoint.x + mRadius + mArcWidth + 1, mCenterPoint.y, mArcPaint);
                canvas.rotate(mDialIntervalDegree, mCenterPoint.x, mCenterPoint.y);
            } else {
                canvas.drawLine(mCenterPoint.x + mRadius - 1, mCenterPoint.y, mCenterPoint.x + mRadius + mArcWidth + 1, mCenterPoint.y, mBgArcPaint);
                canvas.rotate(mDialIntervalDegree, mCenterPoint.x, mCenterPoint.y);
            }
        }
        canvas.restore();
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText("¥ "+ Tool.formatPrice(mValue), mCenterPoint.x, mValueOffset, mValuePaint);
        if (mUnit != null) {
    ...
    private void startAnimator(float start, float end, long animTime) {
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.e(TAG, "onAnimationUpdate: percent = " + mPercent
