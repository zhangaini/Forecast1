...
import com.forecast.forecast.adapters.wheel.NumericWheelAdapter;
...
public class WheelTime
{
	...
	public static int DEFULT_END_YEAR = 2050;
...
//        DEFULT_END_YEAR = Tool.getYear();
	...
	public void setPicker(int year, int month, int day, int h, int m)
	{
        ...
        if (type == TimePickerView.Type.YEAR_YEAR){
			// 年
        ...
        }else if (type == TimePickerView.Type.MONTH_YEAR){

			// 月
			wv_month = (WheelView) view.findViewById(R.id.year);
			wv_month.setAdapter(new NumericWheelAdapter(1, 12, "%02d"));
			//wv_month.setLabel(context.getString(R.string.pickerview_month));
			wv_month.setCurrentItem(month);

			// 年
			wv_year = (WheelView) view.findViewById(R.id.month);
			wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"年"的显示数据
