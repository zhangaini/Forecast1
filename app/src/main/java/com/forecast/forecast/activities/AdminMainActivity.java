...
import com.forecast.forecast.fragments.AdminHomeFragment_;
import com.forecast.forecast.fragments.AdminMineFragment_;
...
public class AdminMainActivity extends BaseActivity {
    ...
    void initView() {
        ...
        TabInfo homeTabInfo = new TabInfo(AdminHomeFragment_.builder().build(), R.drawable.tab_home, R.string.tab_home);
        infos.add(homeTabInfo);


        TabInfo mineTabInfos = new TabInfo(AdminMineFragment_.builder().build(), R.drawable.tab_mine, R.string.tab_mine);
