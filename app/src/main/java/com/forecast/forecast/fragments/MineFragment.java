...
public class MineFragment extends BaseFragment {
    ...
    public void getData(){
        ...
        bmobQuery.getObject(getActivity(), objectId, new GetListener<User>() {
            ...
            public void onSuccess(User user) {
                ...
                tvLogin.setText(user.getAccount().substring(0,3)+"*****"+ user.getAccount().substring(7));
                if (user.getImg() == null){
     ...
     * 紧急联系人
     */
    @Click(R.id.rl_contanct)
    void rlContact(){

        showFragment(getActivity(),ContactFragment_.builder().build());
