...
public class AddRateHighFragment extends BaseFragment {
    ...
    void initView(){
        ...
        pickerView.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date) {
                examDate = date;
                String time = Tool.formatSimpleDate3(date);
    ...
    void btSave(){
        ...
        RateHigh rateHigh = new RateHigh();
        rateHigh.setNumber(number);
        rateHigh.setUserId(objectId);
        rateHigh.setScore(score);
        rateHigh.setTime(new BmobDate(endCalendar.getTime()));


        rateHigh.save(getContext(), new SaveListener() {
            @Override
