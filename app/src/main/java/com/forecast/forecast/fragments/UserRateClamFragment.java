...
public class UserRateClamFragment extends BaseFragment {
    ...
    void tvMore(){
        ...
        showFragment(getActivity(),RateClamMoreFragment_.builder().build());
    }
    ...
    public void initCart(List<RateClam> rateClams){
