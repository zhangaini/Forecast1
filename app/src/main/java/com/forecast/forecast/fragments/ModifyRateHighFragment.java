...
public class ModifyRateHighFragment extends BaseFragment {
    ...
    void initView(){
        ...
        rateHigh = (RateHigh) getArguments().getSerializable("data");

        rlTime.setVisibility(View.GONE);
        etNumber.setText(rateHigh.getNumber());
        etScore.setText(rateHigh.getScore());
    ...
    void btSave(){
        ...
        rateHigh.setNumber(number);
        rateHigh.setScore(score);

        rateHigh.update(getContext(), new UpdateListener() {
            @Override
            public void onSuccess() {
                EventBus.getDefault().post(new String(Constant.EVEBUSRATEHIGH));
