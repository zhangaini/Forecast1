...
public class AddRateUpFragment extends BaseFragment {
    ...
    void btSave(){
        ...
        RateUp rateUp = new RateUp();
        rateUp.setNumber(number);
        rateUp.setUserId(objectId);
        rateUp.setScore(score);
        rateUp.setTime(new BmobDate(endCalendar.getTime()));


        rateUp.save(getContext(), new SaveListener() {
            @Override
