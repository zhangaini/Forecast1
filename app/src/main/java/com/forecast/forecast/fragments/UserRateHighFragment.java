...
public class UserRateHighFragment extends BaseFragment {
    ...
    void tvMore(){
        ...
        showFragment(getActivity(),RateHighMoreFragment_.builder().build());
    }
    ...
    public void initCart(List<RateHigh> rateClams){
