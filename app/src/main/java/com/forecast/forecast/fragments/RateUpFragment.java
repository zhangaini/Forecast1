...
import com.forecast.forecast.adapters.RateUpAdapter;
...
public class RateUpFragment extends BaseFragment {
    ...
    private RateUpAdapter rateUpAdapter;
    ...
    void initView(){
        ...
        navBar.setOnMenuClickListener(new NavBarBack.OnMenuClickListener() {
            ...
            public void onRightMenuClick(View view) {
                ...
                AddRateUpFragment addRateUpFragment = AddRateUpFragment_.builder().build();
                Bundle bundle = new Bundle();
                bundle.putString("objectId",objectId);
                addRateUpFragment.setArguments(bundle);
                showFragment(getActivity(),addRateUpFragment);
            }
        });

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(rateUpAdapter = new RateUpAdapter(getActivity(),adapterListener));

        getData();
    }


    AdapterListener adapterListener = new AdapterListener<RateUp>() {
        @Override
        public void setItemClickListener(RateUp rateUp, int position) {

            ModifyRateUpFragment modifyRateUpFragment = ModifyRateUpFragment_.builder().build();
            Bundle bundle = new Bundle();
            bundle.putSerializable("data",rateUp);
            modifyRateUpFragment.setArguments(bundle);
            showFragment(getActivity(),modifyRateUpFragment);
        }
    };
    ...
    public void refreshData(String str){
        if (str.equals(Constant.EVEBUSRATEUP)){
            getData();
        }
    }
