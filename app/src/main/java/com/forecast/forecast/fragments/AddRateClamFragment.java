...
public class AddRateClamFragment extends BaseFragment {
    ...
    void btSave(){
        ...
        RateClam rateClam = new RateClam();
        rateClam.setNumber(number);
        rateClam.setUserId(objectId);
        rateClam.setScore(score);
        rateClam.setTime(new BmobDate(endCalendar.getTime()));


        rateClam.save(getContext(), new SaveListener() {
            @Override
