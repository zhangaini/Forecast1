 ...
 * 创建时间： 2017/8/9 11:31
 **/
public class RateClamAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RateClamAdapter(Context mContext, AdapterListener adapterListener){
