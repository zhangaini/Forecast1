 ...
 * 创建时间： 2017/8/9 11:31
 **/
public class RateTimeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RateTimeAdapter(Context mContext, AdapterListener adapterListener){
