 ...
 * 创建时间： 2017/8/9 11:31
 **/
public class RateHighAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RateHighAdapter(Context mContext, AdapterListener adapterListener){
