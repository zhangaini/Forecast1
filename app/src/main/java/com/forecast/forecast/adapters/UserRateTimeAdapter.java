 ...
 * 创建时间： 2017/8/9 11:31
 **/
public class UserRateTimeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private int VIEWTILE = 1;
    private Context mContext;
    private List<RateTime> list_object = new ArrayList<>();
    private AdapterListener adapterListener;

    public UserRateTimeAdapter(Context mContext, AdapterListener adapterListener){
        this.mContext = mContext;
        this.adapterListener = adapterListener;
    }

    public void setData(List<RateTime> list_object){
