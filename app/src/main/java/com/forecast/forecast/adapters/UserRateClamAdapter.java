 ...
 * 创建时间： 2017/8/9 11:31
 **/
public class UserRateClamAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private int VIEWTILE = 1;
    private Context mContext;
    private List<RateClam> list_object = new ArrayList<>();
    private AdapterListener adapterListener;

    public UserRateClamAdapter(Context mContext, AdapterListener adapterListener){
        this.mContext = mContext;
        this.adapterListener = adapterListener;
    }

    public void setData(List<RateClam> list_object){
